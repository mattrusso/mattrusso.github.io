...
function drawGraph(data, title, id) {
    ...
    svg.append("path").data([data]).attr("class", "line").attr("d", valueline).attr("clip-path", "url(#clip)");
...
function drawMap() {
    ...
    d3.json("/../data/test2.json", function (error, data) {
        ...
        var svg1 = d3.select("#map").append("svg").attr("width", "100%").attr("height", "100%").style("background", "#C2EDEB");
